...
if __name__ == '__main__':
    ...
    print("Training on training1.txt, running tests on test1.txt. "
          "Output --> output1.txt")
    os.system("python3 tagger.py -d training1.txt training2.txt -t test4.txt -o output12_4.txt")
    ...
    with open("output12_4.txt", "r") as output_file, \
         open("training4.txt", "r") as solution_file, \
         open("results12_4.txt", "w") as results_file:
