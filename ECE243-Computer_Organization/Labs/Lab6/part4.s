...
CONFIG_PRIV_TIMER:                              
                ...
                STR     R1, [R0]
                MOV     R1, #0b111
                STR     R1, [R0, #8]        // Enable interrupt, auto-reload, and timer                
                BX      LR          
...
/* Handle private timer interrupt */            
PRIV_TIMER_ISR:
                PUSH    {R0-R7, LR}
                LDR     R3, =0xFFFEC600
                MOV     R2, #1
                ...
                MOV     R0, R2
                BL      DIVIDE
                MOV     R3, R2           // R3: Thousdands digit
                MOV     R2, R0           // R2: Hundreds digit
                POP     {R1}             // R1: Tens digit
                POP     {R0}             // R0: Ones digit
                BL      DISPLAY
                STR     R3, HEX_code
                POP     {R0-R7, LR}
                BX      LR               // Go back to SERVICE_IRQ
